...
public class ProductBean implements Serializable {
    ...
    public ImgBean getFirstImages() {

    	// magari implementare un criterio con la quale si sceglie
    	// la prima immagine di un prodotto
    ...
    public void setQTA_ordinata(int QTA_ordinata) {
        this.QTAordinata = QTA_ordinata;
    }
